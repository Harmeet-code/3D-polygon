...
32. clicking on booth doesnt do anything ie doesnt zoom/focus, doesnt show youTube video, show tooltip, 
The buildBooths() in the old code calls fillDropdowns(), applyFilters(), and rebuildBlockedGrid() internally.
In the new code, buildBooths() in BoothBuilder.js does NOT call these. Instead, main.js calls them separately:
...
22. have size and booth number(from JSON) on top of polygon
